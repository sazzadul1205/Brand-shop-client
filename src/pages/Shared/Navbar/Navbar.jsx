...
const Navbar = () => {
    ...
    const links = (
        <>
            ...
            <li className="text-xl"><NavLink to={'/addProducts'}>Add Products</NavLink></li>
    ...
    return (
        <div className="mb-10">
            <div className="navbar bg-green-600 pt-4 md:px-20">
                <div className="navbar-start">
                    ...
                    <a className="hidden lg:inline-block">
                        <img className="w-40" src={'https://i.ibb.co/hMmym91/icon-navbar.png'} alt="https://i.ibb.co/hMmym91/icon-navbar.png" />
                    </a>
                </div>
